...
export default function Contact() {
  ...
  const socialLinks = [
    { href: "https://github.com/Nounagnon02", icon: <GitHubIcon />, label: "GitHub" },
    { href: "https://www.linkedin.com/in/nounagnon-prince-kangbode-a9a9a62b4?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app", icon: <LinkedInIcon />, label: "LinkedIn" },
    { href: "https://wa.me/2290190112477", icon: <WhatsAppIcon />, label: "WhatsApp" },
    { href: "https://www.facebook.com/profile.php?id=100074745955438", icon: <FacebookIcon />, label: "Facebook" }
  ];
